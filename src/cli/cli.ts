...
/**
 * Interface that defines the command line arguments
 *
 * @interface CliArgs
 *
 ...
 */
interface CliArgs {
  /** List of files/directories to test */
  files: string[];
 ...
 */
function getReporter(name: string, outputFile?: string): Reporter {
...
async function main(): Promise<void> {
  ...
  if (args.showPatterns) {
    ...
    config.pattern.forEach((p: string) => console.log(`  ${color.green('✓')} ${p}`));
