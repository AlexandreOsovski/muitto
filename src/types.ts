...
export type ReporterEvent =
  ...
  | { type: "file_end"; result: FileResult }
  /** An individual test is about to start */
  | { type: "test_start"; test: TestCase }
  /** An individual test has finished */
  | { type: "test_end"; result: TestResult }
  /** A test suite is being entered */
  | { type: "suite_start"; name: string }
  /** A test suite has been completed */
  | { type: "suite_end"; name: string }
  /** A lifecycle hook is about to execute */
  | { type: "hook_start"; hookType: "beforeAll" | "afterAll" | "beforeEach" | "afterEach" }
  /** A lifecycle hook has finished executing */
  | { type: "hook_end"; hookType: "beforeAll" | "afterAll" | "beforeEach" | "afterEach" }
...
export type {
  ...
  MockFn as MockFnType,
  SpyFn as SpyFnType,
  FakeTimers as FakeTimersType,
  Matchers as MatchersType,
  Expect as ExpectType,
  Reporter as ReporterType,
  MuittoConfig as MuittoConfigType,
